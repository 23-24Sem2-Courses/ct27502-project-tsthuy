<header class="bg-blue-700 text-white p-4 uppercase ">
    <div class="container mx-auto flex justify-between items-center">
        <a href="home.php" class="text-2xl font-bold">Hệ thống <br /> quản lý thư viện</a>
        <!-- Phần tìm kiếm -->
        <form action="home.php" method="GET" class="flex items-center">
            ...
            <button type="submit" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-md">Tìm kiếm</button>
        </form>
        <!-- Kết thúc phần tìm kiếm -->

        <!-- Dropdown danh sách thể loại sách -->
        <div class="relative">
            <select onchange="location = this.value;" class="block appearance-none w-full bg-green-500 border 
